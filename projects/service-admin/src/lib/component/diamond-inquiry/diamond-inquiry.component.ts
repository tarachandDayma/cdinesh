...
declare var $: any;
@Component({
  selector: 'lib-diamond-inquiry',
  templateUrl: './diamond-inquiry.component.html',
  styleUrls: ['./diamond-inquiry.component.css']
})
export class DiamondInquiryComponent implements OnInit,OnChanges {
